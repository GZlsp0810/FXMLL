            ...
            <div class="login-wrap">
                <form id="form" method="post" action="http://localhost:8081/user/login">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="登录账号" value="">
                    ...
                    <div class="form-group">
                        <span id="button" onclick="login()"   class="btn btn-info login-btn"> 登&nbsp;&nbsp;录 </span>
...
<div id="" style="position: fixed; bottom: 110px; right: 10px; opacity: 0; cursor: pointer; " title="返回顶部"><div class="back-to-top"></div></div>
...
<script type="text/javascript">
    $(function () {
        ...
        submitBtn.click(function () {
            ...
            if(.is(':visible') && filterSqlStr(_val)){
...
<script type="text/javascript">
 function login() {
     var phoneStr = $("#phone").val();
      ...
      $.post("login",{phone:phoneStr,password:passwordStr},function (data) {
          if(data.code==1){
            //登录成功
...
<div id="topcontrol" title="返回顶部" style="position: fixed; bottom: 110px; right: 10px; opacity: 0; cursor: pointer;"><div class="back-to-top"></div></div></body>
</html>

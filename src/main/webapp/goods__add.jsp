...
<head>
    ...
    <link href="./static/default.css" rel="stylesheet" id="lhgdialoglink">
                    ...
                    <div class="widget-main">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="order_no" name="order_no" onkeyup="checkVal2(this);"
                                           value="">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="sell_num" name="sell_num" onkeyup="checkVal2(this);"
                                           value="">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div id="sm_div">
                                        ...
                                        <img src="./static/no_pic.png" id="sm_yl"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="uploadGood" id="smfile&quot;"
                                           style="width:540px;height:22px;cursor:hand" class="fileinput"
                                           onchange="checkImgType(this);setPreview(this,'sm_yl','sm_div',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div id="sm_div1">
                                        ...
                                        <img src="./static/no_pic.png" id="sm_yl1"
                                             style="width:240px;height:150px;border:1px solid #ddd;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="uploadGood" id="smfile1&quot;"
                                           style="width:540px;height:22px;cursor:hand" class="fileinput"
                                           onchange="checkImgType(this);setPreview(this,'sm_yl1','sm_div1',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div id="sm_div2">
                                        ...
                                        <img src="./static/no_pic.png" id="sm_yl2"
                                             style="width:240px;height:150px;border:1px solid #ddd;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="uploadGood" id="smfile2&quot;"
                                           style="width:540px;height:22px;cursor:hand" class="fileinput"
                                           onchange="checkImgType(this);setPreview(this,'sm_yl2','sm_div2',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table id="tcbg" class="table table-bordered table-striped">
                                        <tbody>
                                        <tr>
                                            <th align="left" style="background-color:#F9F9F9">(<font
                                                    color="red">*</font>)描述
                                            </th>
                                            <th align="left" style="background-color:#F9F9F9">(<font
                                                    color="red">*</font>)成本
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="lbl">&nbsp;<a
                                            href="http://localhost:8081/cust/goods/add#">11</a></span><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" class="ace" id="copy_39201701" name="zcopy_id"
                                           value="39201701">
                                    <span class="lbl">&nbsp;<a
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="copy_desc" name="copy_desc"
                                              style="width:540px; height:80px;"></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="forward_link" name="forward_link" style="width:540px;"
                                           value="">
                                </td>
                            </tr>
